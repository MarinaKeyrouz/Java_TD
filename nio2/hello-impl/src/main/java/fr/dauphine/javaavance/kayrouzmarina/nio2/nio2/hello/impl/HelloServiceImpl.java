...
import fr.dauphine.javaavance.kayrouzmarina.nio2.nio2.hello.api.GreetingMessage;
import fr.dauphine.javaavance.kayrouzmarina.nio2.nio2.hello.api.HelloService;
import fr.dauphine.javaavance.kayrouzmarina.nio2.nio2.hello.impl.HelloCommand.*;
...
public class HelloServiceImpl implements HelloService {
  ...
  @Override
  public Topic<fr.dauphine.javaavance.kayrouzmarina.nio2.nio2.hello.api.HelloEvent> helloEvents() {
    ...
    return TopicProducer.taggedStreamWithOffset(HelloEvent.TAG.allTags(), (tag, offset) ->
      ...
      fr.dauphine.javaavance.kayrouzmarina.nio2.nio2.hello.api.HelloEvent eventToPublish;
      ...
      if (eventAndOffset.first() instanceof HelloEvent.GreetingMessageChanged) {
        ...
        eventToPublish = new fr.dauphine.javaavance.kayrouzmarina.nio2.nio2.hello.api.HelloEvent.GreetingMessageChanged(
